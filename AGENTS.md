...
- **Active roadmap work starts after Phase 1:** use `docs/superpowers/plans/2026-06-19-unified-feature-roadmap.md` for follow-on slices unless the user explicitly asks to revise the historical Phase 1 document. Keep `docs/superpowers/plans/2026-04-18-phases2-8-iteration-plan.md` as the historical Phases 2-8 closure reference and `archived/plans/2026-05-09-finish-started-work-plan-rf0-complete.md` as the started-work closure record.
