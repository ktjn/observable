...
The version source of truth is now defined and enforced. The next items are immutable tag-based
artifact builds, multi-architecture container publishing, Helm chart publishing, signing, and
