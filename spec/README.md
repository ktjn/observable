...
| [10-process.md](10-process.md) | ADRs, development process, local development, CI/build process, phased project plan |
| [11-testing.md](11-testing.md) | Test strategy, local test scope, CI gates, test data, non-functional targets |
| [12-deployment.md](12-deployment.md) | Deployment, local environments, build artifacts, tooling recommendations, build-vs-buy |
