...
| [10-process.md](10-process.md) | ADRs, development process, phased project plan |
| [11-testing.md](11-testing.md) | Test strategy, test data, non-functional targets |
| [12-deployment.md](12-deployment.md) | Deployment, tooling recommendations, build-vs-buy |
